# TODO(phlip9): un-vendor this when <https://github.com/nix-community/home-manager/pull/5786> lands
{
  config,
  options,
  lib,
...
with lib; let
  cfg = config.services.gpg-agent-phlip9;
  ...
  in
    ...
    then "/private/var/run/org.nix-community.home.gpg-agent-phlip9/${subdir}"
    else "%t/gnupg/${subdir}";
  ...
  mkSocket = {
    ...
    Socket = {
      ...
      Service = "gpg-agent-phlip9.service";
      SocketMode = "0600";
      DirectoryMode = "0700";
    };
